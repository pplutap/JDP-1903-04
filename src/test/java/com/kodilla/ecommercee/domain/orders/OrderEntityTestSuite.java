...
public class OrderEntityTestSuite {
    ...
    public void testOrderSaveWithItems() {
        //Given
        Item item1 = new Item(1L, "TestName1",  new BigDecimal(2.5), 2);
        Item item2 = new Item(2L, "TestName2",  new BigDecimal(2.5), 3);
    ...
    public void testOrderSaveWhenItemIsNull() {
        //Given
        Item item1 = null;
        Item item2 = new Item(2L, "TestName2", new BigDecimal(3.5), 1);

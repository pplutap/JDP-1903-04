...
public class CartController {
    ...
    @Autowired
    public CartController(CartMapper cartMapper, ProductMapper productMapper, ProductService productService) {
    ...
    public void addItemToCart(@RequestBody ProductDto productDto, CartDto cartDto) {
        Cart newCart = new Cart(cartDto.getCartId(), productService.getAllProducts());
    ...
    public void deleteProductFromCart(@RequestParam Long productId, Long cartId) {
        Cart newCart = new Cart(cartId, productService.getAllProducts());
